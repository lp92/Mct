...
Z([3,'id'])
Z([3,'__e'])
Z([[4],[[5],[[5],[1,'tab-item-title']],[[2,'?:'],[[2,'=='],[[7],[3,'tabIndex']],[[7],[3,'index']]],[1,'tab-item-title-active'],[1,'']]]])
Z([[7],[3,'index']])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'ontabtap']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[6],[[7],[3,'tab']],[3,'id']])
Z([a,[[6],[[7],[3,'tab']],[3,'name']]])
Z([3,'line-h'])
Z([3,'display:flex;margin-left:20rpx;margin-top:20rpx;align-items:center;justify-content:flex-start;line-height:26rpx;'])
Z([3,'imagex'])
Z([3,'x12'])
Z([3,'aspectFill'])
Z([[7],[3,'ydimg2']])
...
Z([3,'xindex'])
Z([3,'xx'])
Z([[6],[[7],[3,'tab']],[3,'gridlist']])
Z(z[37])
Z(z[31])
Z([3,'error'])
Z([[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[1,'2-'],[[7],[3,'index']]],[1,'-']],[[7],[3,'xindex']]],[1,',']],[[2,'+'],[1,'1-'],[[7],[3,'index']]]])
Z(z[36])
Z(z[6])
Z(z[14])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'changexx']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z(z[8])
Z([[7],[3,'xindex']])
Z([[2,'+'],[[2,'+'],[1,'u'],[[7],[3,'index']]],[[7],[3,'xindex']]])
Z(z[16])
Z([[6],[[7],[3,'xx']],[3,'url']])
Z(z[18])
Z([a,[[6],[[7],[3,'xx']],[3,'text']]])
...
Z([[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[1,'width:'],[[2,'+'],[[6],[[7],[3,'dots']],[3,'width']],[1,'px']]],[1,';']],[[2,'+'],[[2,'+'],[1,'height:'],[[2,'+'],[[6],[[7],[3,'dots']],[3,'height']],[1,'px']]],[1,';']]],[[2,'+'],[[2,'+'],[1,'background-color:'],[[2,'?:'],[[2,'!=='],[[7],[3,'index']],[[2,'-'],[[7],[3,'current']],[1,1]]],[[6],[[7],[3,'dots']],[3,'backgroundColor']],[[6],[[7],[3,'dots']],[3,'selectedBackgroundColor']]]],[1,';']]],[[2,'+'],[[2,'+'],[1,'border:'],[[2,'?:'],[[2,'!=='],[[7],[3,'index']],[[2,'-'],[[7],[3,'current']],[1,1]]],[[6],[[7],[3,'dots']],[3,'border']],[[6],[[7],[3,'dots']],[3,'selectedBorder']]]],[1,';']]])
Z([[7],[3,'hide_good_box']])
Z([3,'good_box'])
Z([[7],[3,'ydimg']])
...
var x=['./components/uni-badge/uni-badge.wxml','./components/uni-grid-item/uni-grid-item.wxml','./components/uni-grid/uni-grid.wxml','./pages/swiperx/swiperx.wxml'];d_[x[0]]={}
...
var oH=_mz(z,'view',['class',3,'style',1],[],e,s,gg)
var cI=_v()
_(oH,cI)
...
var eN=_mz(z,'uni-badge',['bind:__l',11,'inverted',1,'size',2,'text',3,'type',4,'vueId',5],[],e,s,gg)
_(tM,eN)
_(oJ,tM)
}
var lK=_v()
...
var oP=_mz(z,'image',['class',20,'mode',1,'src',2,'style',3],[],e,s,gg)
_(bO,oP)
_(lK,bO)
}
var xQ=_n('view')
...
var f7=_mz(z,'text',['bindtap',6,'class',1,'data-current',2,'data-event-opts',3,'id',4],[],o4,b3,gg)
var c8=_oz(z,11,o4,b3,gg)
_(f7,c8)
_(x5,f7)
return x5
}
t1.wxXCkey=2
_2z(z,4,e2,e,s,gg,t1,'tab','index','id')
_(oX,aZ)
var h9=_n('view')
_rz(z,h9,'class',12,e,s,gg)
_(oX,h9)
var o0=_n('view')
_rz(z,o0,'style',13,e,s,gg)
var cAB=_mz(z,'image',['class',14,'id',1,'mode',2,'src',3],[],e,s,gg)
_(o0,cAB)
var oBB=_mz(z,'text',['class',18,'style',1],[],e,s,gg)
...
var bGB=_mz(z,'swiper',['bindchange',22,'current',1,'data-event-opts',2,'duration',3],[],e,s,gg)
var oHB=_v()
_(bGB,oHB)
var xIB=function(fKB,oJB,cLB,gg){
var oNB=_n('swiper-item')
_rz(z,oNB,'class',30,fKB,oJB,gg)
var cOB=_mz(z,'uni-grid',['bind:__l',31,'column',1,'highlight',2,'showBorder',3,'vueId',4,'vueSlots',5],[],fKB,oJB,gg)
var oPB=_v()
_(cOB,oPB)
var lQB=function(tSB,aRB,eTB,gg){
var oVB=_mz(z,'uni-grid-item',['bind:__l',41,'type',1,'vueId',2,'vueSlots',3],[],tSB,aRB,gg)
var xWB=_mz(z,'image',['bindtap',45,'class',1,'data-event-opts',2,'data-xid1',3,'data-xid2',4,'id',5,'mode',6,'src',7],[],tSB,aRB,gg)
_(oVB,xWB)
var oXB=_n('text')
_rz(z,oXB,'class',53,tSB,aRB,gg)
var fYB=_oz(z,54,tSB,aRB,gg)
_(oXB,fYB)
_(oVB,oXB)
_(eTB,oVB)
return eTB
...
oPB.wxXCkey=4
_2z(z,39,lQB,fKB,oJB,gg,oPB,'xx','xindex','xindex')
_(oNB,cOB)
_(cLB,oNB)
return cLB
}
oHB.wxXCkey=4
_2z(z,28,xIB,e,s,gg,oHB,'tab','index','index')
_(aDB,bGB)
var tEB=_v()
_(aDB,tEB)
if(_oz(z,55,e,s,gg)){tEB.wxVkey=1
var cZB=_mz(z,'view',['class',56,'style',1],[],e,s,gg)
var h1B=_v()
_(cZB,h1B)
var o2B=function(o4B,c3B,l5B,gg){
var t7B=_mz(z,'view',['class',62,'style',1],[],o4B,c3B,gg)
_(l5B,t7B)
return l5B
}
h1B.wxXCkey=2
_2z(z,60,o2B,e,s,gg,h1B,'item','index','index')
_(tEB,cZB)
}
var eFB=_v()
_(aDB,eFB)
if(_oz(z,64,e,s,gg)){eFB.wxVkey=1
var e8B=_mz(z,'image',['class',65,'src',1,'style',2],[],e,s,gg)
_(eFB,e8B)
}
tEB.wxXCkey=1
eFB.wxXCkey=1
...
var lY=_v()
_(oX,lY)
if(_oz(z,69,e,s,gg)){lY.wxVkey=1
var xAC=_n('view')
var oBC=_n('text')
var fCC=_oz(z,70,e,s,gg)
_(oBC,fCC)
_(xAC,oBC)
_(lY,xAC)
}
...
__wxAppCode__['pages/swiperx/swiperx.wxss']=setCssToHead([".",[1],"c { background-color: #ffffff; height: 100%; }\n.",[1],"swiper_t { width: ",[0,750],"; height: ",[0,100],"; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-align-content: center; -ms-flex-line-pack: center; align-content: center; -webkit-flex-wrap: nowrap; -ms-flex-wrap: nowrap; flex-wrap: nowrap; display: -webkit-inline-box; display: -webkit-inline-flex; display: -ms-inline-flexbox; display: inline-flex; }\n.",[1],"tab-item-title { color: #555; font-size: ",[0,30],"; height: ",[0,100],"; -webkit-flex-wrap: nowrap; -ms-flex-wrap: nowrap; flex-wrap: nowrap; line-height: ",[0,100],"; -o-text-overflow: ellipsis; text-overflow: ellipsis; overflow: hidden; max-width: ",[0,200],"; margin: ",[0,0]," ",[0,20],"; }\n.",[1],"tab-item-title-active { color: #007AFF; }\n.",[1],"line-h { height: ",[0,1],"; background-color: #cccccc; }\n.",[1],"swiper-box { width: 100%; height: ",[0,490],"; position: relative; }\n.",[1],"swiper-box wx-swiper { height: ",[0,470],"; }\n.",[1],"uni-swiper__dots-box { position: absolute; bottom: ",[0,20],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-sizing: box-sizing; box-sizing: box-sizing; width: 100%; }\n.",[1],"uni-swiper__dots-item { -webkit-flex-shrink: 0; -ms-flex-negative: 0; flex-shrink: 0; width: ",[0,16],"; border-radius: 50%; margin-left: ",[0,12],"; background: rgba(0, 0, 0, .3); -webkit-transition: all 0.2s linear; -o-transition: all 0.2s linear; transition: all 0.2s linear; }\n.",[1],"uni-swiper__dots-item:first-child { margin: 0; }\n.",[1],"imagex { width: ",[0,60],"; height: ",[0,60]," }\n.",[1],"textx { font-size: ",[0,26],"; text-align: center; }\n.",[1],"good_box { width: ",[0,50],"; height: ",[0,50],"; position: fixed; overflow: hidden; z-index: +99; }\n",],undefined,{path:"./pages/swiperx/swiperx.wxss"});    
__wxAppCode__['pages/swiperx/swiperx.wxml']=$gwx('./pages/swiperx/swiperx.wxml');
